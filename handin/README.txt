...
The folder 'test' contain some testing code we use to verify our models, you might need to move them to current diretory for working. Simply run the test code and the results will show.
